  ...
  async function speak(text) {
    ...
    fetch("/api/detectLanguage?text="+text, {
      ...
      .then(async language => {
        ...
        if (language == 'en-US') {
          spokenTextssml = `<speak version='1.0' xmlns='http://www.w3.org/2001/10/synthesis' xmlns:mstts='https://www.w3.org/2001/mstts' xml:lang='en-US'><voice xml:lang='en-US' xml:gender='Female' name='en-US-JennyNeural'><lang xml:lang="${language}">${generatedResult}</lang></voice></speak>`
        }
